-- Esquema de Referência para Cloudflare D1 (SQL)
-- Este arquivo é apenas para documentação, o app utiliza Firebase Firestore.

-- Tabela de Perfis de Usuários (Colaboradores)
CREATE TABLE IF NOT EXISTS user_profiles (
    ...
    fixed_dsr_days TEXT DEFAULT '[0]', -- Armazenado como JSON array
...
-- Tabela de Registros Diários (Batidas)
CREATE TABLE IF NOT EXISTS daily_entries (
    id TEXT PRIMARY KEY, -- Formato: DD-MM-YYYY
    monthly_summary_id TEXT NOT NULL,
    user_profile_id TEXT NOT NULL,
    date TEXT NOT NULL,
    times TEXT DEFAULT '[]', -- Armazenado como JSON array de horários
